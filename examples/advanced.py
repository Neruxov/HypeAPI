...
# !!! IMPORTANT !!!
# This example was written using Python 3.10, so you have a thing called "match" and "case". If you use any version lower than 3.10, you will have to use "if", "else", "elif" with every option.
# !!! IMPORTANT !!!
